...
I build practical projects that combine **Python, Machine Learning, Computer Vision, IoT, Robotics, and Embedded Systems**.

I enjoy taking an idea from scratch to a working project — from designing the logic and circuits to writing the software and documenting the result.
...
- 🤖 Interested in **AI/ML, Computer Vision, Robotics and intelligent systems**
- 🧠 Experience with **scikit-learn, OpenCV, NumPy, Pandas and Matplotlib**
- 🔌 Build Arduino and ESP32/ESP8266 projects from scratch
- 📷 Work with live camera and computer-vision applications
- ⚙️ Comfortable with sensors, motors, servos, relays and motor drivers
- 🖥️ Build desktop interfaces with **Tkinter**
- 📱 Experience building Flutter/Dart applications
- 📚 Currently focused on building a strong portfolio of real-world projects
...
- Build **5 strong, well-documented portfolio projects**
- Go deeper into **Machine Learning and Computer Vision**
- Build more advanced **robotics and intelligent embedded systems**
- Improve software architecture, testing and engineering practices
- Contribute to open-source projects
- Prepare for professional software development and freelance opportunities
